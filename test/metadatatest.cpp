...
TEST( MetadataTest, ParseFlacSample) {
    ...
    EXPECT_EQ( 8000, _codec->sample_rate() );
...
TEST( MetadataTest, ParseAviSample) {
    ...
    auto _codec = _format.find_codec( CODEC_TYPE::VIDEO );
...
TEST( MetadataTest, ParseDivxMicayala_DivX1080p_ASP) {
    ...
    auto _video_codec = _format.find_codec( CODEC_TYPE::VIDEO );
    auto _audio_codec = _format.find_codec( CODEC_TYPE::AUDIO );
